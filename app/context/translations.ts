export const translations = {
  en: {
    ...
    githubFeedExtras: {
      ...
      stars: "Stars",
      followers: "Followers",
      liveData: "Live GitHub data from public repositories",
    ...
    loginModal: {
      ...
      errorDenied: "Invalid credentials. Access denied.",
      errorUnreachable: "Authentication server unreachable."
    },
    terminal: {
      bootText: [
      ...
      notFound: "Command not found: {cmd}. Type 'help' for commands.",
      lokiText: [
  ...
  de: {
    ...
    bioSection: {
      role: "Daten-Ingenieur Berater",
      exploreProjects: "Projekte erkunden",
      contactMe: "Kontaktieren Sie mich",
      pipelineActive: "Pipeline Aktiv",
      rowsPerSec: "Zeilen / Sek"
    },
    githubFeedExtras: {
      repos: "Repos",
      stars: "Sterne",
      followers: "Follower",
      liveData: "Live-GitHub-Daten aus öffentlichen Repositories",
      pushEvents: "Push-Ereignisse",
      metadataSync: "Metadaten-Synchronisierung"
    },
    loginModal: {
      adminLogin: "Admin-Login",
      ...
      loginButton: "Beim Panel anmelden",
      errorBoth: "Bitte geben Sie Benutzername und Passwort ein.",
      errorDenied: "Ungültige Anmeldedaten. Zugriff verweigert.",
      errorUnreachable: "Authentifizierungsserver nicht erreichbar."
    },
    terminal: {
      bootText: [
        "Initialisiere LOKI-Protokoll-Terminal v1.0...",
        "Lade Profil: Ijlal Ansari...",
      ...
      helpText: [
        "BEFEHL         BESCHREIBUNG",
        "-------        -----------",
        "about          Gibt den vollständigen Biografie-Absatz aus",
        "skills         Gibt ein ASCII-Balkendiagramm der Fähigkeiten aus",
        "projects       Listet alle 6 Projekte auf",
        "contact        Zeigt soziale Links",
        "loki           Spezielle Protokollinformationen",
        "hire           Gehe zum Kontaktbereich",
        "clear          Löscht das Terminal",
        "exit           Schließt das Terminal"
      ],
      aboutText: [
        "Senior Daten-Ingenieur & KI-Forscher, spezialisiert auf ethische Datenintelligenz.",
        "Aufbau des LOKI-Protokolls für einen glorreichen Zweck, freien Willen und bessere Datensysteme über die gesamte Zeitachse hinweg."
      ],
      projectsText: [
        "1. LOKI-Protokoll - Temporale Datenintelligenz",
        "2. Data Engineering Tracker - Lernpfad",
        "3. ETL-Pipeline - dbt + Dagster",
        "4. Bias Audit System - ML Fairness",
        "5. FastAPI Data Gateway - Sicherer Zugang",
        "6. Analytics Dashboard - DuckDB Backed",
        "Geben Sie 1-6 ein, um mehr zu erfahren (Demnächst)."
      ],
      notFound: "Befehl nicht gefunden: {cmd}. Geben Sie 'help' für Befehle ein.",
      lokiText: [
        "> LOKI — Protokoll zur temporalen Datenanalyse. Für alle Zeit. Immer.",
        "> Lade Pipeline-Module...",
        "> [████████████████████] 100%",
        "> Bias-Erkennung: AKTIV",
        "> Fairlearn-Integration: ONLINE",
        "> SHAP-Erklärbarkeit: ONLINE",
        "> Audit-Protokoll: NUR-ANFÜGEN ✓",
        "> RBAC-Matrix: 24 Berechtigungen geladen",
