  ...
  useEffect(() => {
    ...
    class MagicEmber {
      ...
      constructor() {
        ...
        this.color = Math.random() > 0.5 ? "0, 255, 255" : "248, 250, 252"; // Deep Green / White
      }
    ...
    class TimelineThread {
      ...
      draw(ctx: CanvasRenderingContext2D, isSlipping: boolean) {
        ...
        if (this.lifeEnergy > 0.1) {
           ...
           grad.addColorStop(0.2, `rgba(0, 200, 255, ${alpha * e})`); // Darker Cyan-green
           grad.addColorStop(0.5, `rgba(0, 255, 255, ${alpha * 1.5 * e})`); // Darker Emerald Green
           grad.addColorStop(0.8, `rgba(120, 255, 255, ${alpha * 0.8 * e})`); // Darker Lime/Gold
    ...
    class OrbitalTimeline {
      ...
      draw(ctx: CanvasRenderingContext2D, isSlipping: boolean) {
        ...
        grad.addColorStop(0.5, `rgba(0, 255, 255, ${alpha})`); // Green Magic
    ...
    const render = () => {
      ...
      lightGrad.addColorStop(0, `rgba(0, 255, 255, ${intensity})`);
      lightGrad.addColorStop(0.5, `rgba(0, 255, 255, ${intensity * 0.4})`);
