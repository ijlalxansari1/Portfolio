  ...
  useEffect(() => {
    ...
    class MagicEmber {
      ...
      constructor() {
        ...
        this.color = Math.random() > 0.5 ? "255, 140, 0" : "248, 250, 252"; // Deep Green / White
      }
    ...
    class TimelineThread {
      ...
      draw(ctx: CanvasRenderingContext2D, isSlipping: boolean) {
        ...
        if (this.lifeEnergy > 0.1) {
           ...
           grad.addColorStop(0.2, `rgba(255, 160, 50, ${alpha * e})`); // Darker Cyan-green
           grad.addColorStop(0.5, `rgba(255, 140, 0, ${alpha * 1.5 * e})`); // Darker Emerald Green
           grad.addColorStop(0.8, `rgba(255, 200, 0, ${alpha * 0.8 * e})`); // Darker Lime/Gold
    ...
    class OrbitalTimeline {
      ...
      draw(ctx: CanvasRenderingContext2D, isSlipping: boolean) {
        ...
        grad.addColorStop(0.5, `rgba(255, 140, 0, ${alpha})`); // Green Magic
    ...
    const render = () => {
      ...
      lightGrad.addColorStop(0, `rgba(255, 140, 0, ${intensity})`);
      lightGrad.addColorStop(0.5, `rgba(255, 140, 0, ${intensity * 0.4})`);
      ...
      if (slipping) {
        ...
        if (Math.random() > 0.5) {
          ctx.fillStyle = `rgba(255, 140, 0, ${Math.random() * 0.15})`;
          ctx.fillRect(0, 0, width, height);
        }
    ...
    <>
      ...
      {isMobile ? (
        <div
          ...
          style={{
            backgroundImage: `url('/images/tva_aesthetic_mobile.png')`,
